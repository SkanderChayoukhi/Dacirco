...
def analyze_and_plot(csv_files, output_dir="output_graphs_openstack"):
    """
...
csv_files = [
    "agp-openstack-ok-requests-node-stats.csv",
    "gp-openstack-ok-requests-node-stats.csv",
    "mw-openstack-ok-requests-node-stats.csv",
    "swr-openstack-ok-requests-node-stats.csv",
    "swq-openstack-ok-requests-node-stats.csv"
]
